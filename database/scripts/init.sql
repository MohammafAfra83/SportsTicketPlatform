...
-- 2. Insert Sample Tickets (Ticket 1 uses CURRENT_TIMESTAMP to dynamic-test Query 21)
...
-- 3. Insert Specific Sport Details
...
-- 5. Insert Sample Payments (Payment 1 uses CURRENT_TIMESTAMP to dynamic-test Query 15)
